...
func (m *GenesisState) GetRepresentativesVotingPower() []*VotingPowerRep {
	if m != nil {
		return m.RepresentativesVotingPower
	}
	return nil
}

func (m *GenesisState) GetDelegatorVotingPowerShares() []*VotingPowerDelShares {
	if m != nil {
		return m.DelegatorVotingPowerShares
	}
	return nil
}
...
var fileDescriptor_ef7cfd15e3ded621 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DelegatorVotingPowerShares) > 0 {
		for iNdEx := len(m.DelegatorVotingPowerShares) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DelegatorVotingPowerShares[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.RepresentativesVotingPower) > 0 {
		for iNdEx := len(m.RepresentativesVotingPower) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RepresentativesVotingPower[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.RepresentativesVotingPower) > 0 {
		for _, e := range m.RepresentativesVotingPower {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.DelegatorVotingPowerShares) > 0 {
		for _, e := range m.DelegatorVotingPowerShares {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RepresentativesVotingPower", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RepresentativesVotingPower = append(m.RepresentativesVotingPower, &VotingPowerRep{})
			if err := m.RepresentativesVotingPower[len(m.RepresentativesVotingPower)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelegatorVotingPowerShares", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DelegatorVotingPowerShares = append(m.DelegatorVotingPowerShares, &VotingPowerDelShares{})
			if err := m.DelegatorVotingPowerShares[len(m.DelegatorVotingPowerShares)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
