...
var (
	md_MsgCreateRepresentative                        protoreflect.MessageDescriptor
	fd_MsgCreateRepresentative_description            protoreflect.FieldDescriptor
	fd_MsgCreateRepresentative_representative_address protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_tx_proto_init()
	md_MsgCreateRepresentative = File_cosmos_gov_v1_tx_proto.Messages().ByName("MsgCreateRepresentative")
	fd_MsgCreateRepresentative_description = md_MsgCreateRepresentative.Fields().ByName("description")
	fd_MsgCreateRepresentative_representative_address = md_MsgCreateRepresentative.Fields().ByName("representative_address")
}

var _ protoreflect.Message = (*fastReflection_MsgCreateRepresentative)(nil)

type fastReflection_MsgCreateRepresentative MsgCreateRepresentative

func (x *MsgCreateRepresentative) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgCreateRepresentative)(x)
}

func (x *MsgCreateRepresentative) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgCreateRepresentative_messageType fastReflection_MsgCreateRepresentative_messageType
var _ protoreflect.MessageType = fastReflection_MsgCreateRepresentative_messageType{}

type fastReflection_MsgCreateRepresentative_messageType struct{}

func (x fastReflection_MsgCreateRepresentative_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgCreateRepresentative)(nil)
}
func (x fastReflection_MsgCreateRepresentative_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgCreateRepresentative)
}
func (x fastReflection_MsgCreateRepresentative_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCreateRepresentative
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgCreateRepresentative) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCreateRepresentative
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgCreateRepresentative) Type() protoreflect.MessageType {
	return _fastReflection_MsgCreateRepresentative_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgCreateRepresentative) New() protoreflect.Message {
	return new(fastReflection_MsgCreateRepresentative)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgCreateRepresentative) Interface() protoreflect.ProtoMessage {
	return (*MsgCreateRepresentative)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgCreateRepresentative) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Description != nil {
		value := protoreflect.ValueOfMessage(x.Description.ProtoReflect())
		if !f(fd_MsgCreateRepresentative_description, value) {
			return
		}
	}
	if x.RepresentativeAddress != "" {
		value := protoreflect.ValueOfString(x.RepresentativeAddress)
		if !f(fd_MsgCreateRepresentative_representative_address, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgCreateRepresentative) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgCreateRepresentative.description":
		return x.Description != nil
	case "cosmos.gov.v1.MsgCreateRepresentative.representative_address":
		return x.RepresentativeAddress != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentative"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgCreateRepresentative does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentative) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgCreateRepresentative.description":
		x.Description = nil
	case "cosmos.gov.v1.MsgCreateRepresentative.representative_address":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgCreateRepresentative) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.MsgCreateRepresentative.description":
		value := x.Description
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1.MsgCreateRepresentative does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentative) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgCreateRepresentative.description":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentative) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgCreateRepresentative.description":
		if x.Description == nil {
	...
	case "cosmos.gov.v1.MsgCreateRepresentative.representative_address":
		panic(fmt.Errorf("field representative_address of message cosmos.gov.v1.MsgCreateRepresentative is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentative"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgCreateRepresentative) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgCreateRepresentative.description":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgCreateRepresentative) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.MsgCreateRepresentative", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgCreateRepresentative) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentative) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgCreateRepresentative) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgCreateRepresentative) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgCreateRepresentative)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCreateRepresentative: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCreateRepresentative: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgCreateRepresentativeResponse protoreflect.MessageDescriptor
)

func init() {
	file_cosmos_gov_v1_tx_proto_init()
	md_MsgCreateRepresentativeResponse = File_cosmos_gov_v1_tx_proto.Messages().ByName("MsgCreateRepresentativeResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgCreateRepresentativeResponse)(nil)

type fastReflection_MsgCreateRepresentativeResponse MsgCreateRepresentativeResponse

func (x *MsgCreateRepresentativeResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgCreateRepresentativeResponse)(x)
}

func (x *MsgCreateRepresentativeResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgCreateRepresentativeResponse_messageType fastReflection_MsgCreateRepresentativeResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgCreateRepresentativeResponse_messageType{}

type fastReflection_MsgCreateRepresentativeResponse_messageType struct{}

func (x fastReflection_MsgCreateRepresentativeResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgCreateRepresentativeResponse)(nil)
}
func (x fastReflection_MsgCreateRepresentativeResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgCreateRepresentativeResponse)
}
func (x fastReflection_MsgCreateRepresentativeResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCreateRepresentativeResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgCreateRepresentativeResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgCreateRepresentativeResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgCreateRepresentativeResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgCreateRepresentativeResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgCreateRepresentativeResponse) New() protoreflect.Message {
	return new(fastReflection_MsgCreateRepresentativeResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgCreateRepresentativeResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgCreateRepresentativeResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgCreateRepresentativeResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgCreateRepresentativeResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentativeResponse"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgCreateRepresentativeResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentativeResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentativeResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgCreateRepresentativeResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentativeResponse"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgCreateRepresentativeResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentativeResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentativeResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentativeResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentativeResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgCreateRepresentativeResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgCreateRepresentativeResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgCreateRepresentativeResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.MsgCreateRepresentativeResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgCreateRepresentativeResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgCreateRepresentativeResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgCreateRepresentativeResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgCreateRepresentativeResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgCreateRepresentativeResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCreateRepresentativeResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgCreateRepresentativeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var (
	md_MsgShareVotingPower                     protoreflect.MessageDescriptor
	fd_MsgShareVotingPower_voting_power_shares protoreflect.FieldDescriptor
	fd_MsgShareVotingPower_delegator_address   protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_gov_v1_tx_proto_init()
	md_MsgShareVotingPower = File_cosmos_gov_v1_tx_proto.Messages().ByName("MsgShareVotingPower")
	fd_MsgShareVotingPower_voting_power_shares = md_MsgShareVotingPower.Fields().ByName("voting_power_shares")
	fd_MsgShareVotingPower_delegator_address = md_MsgShareVotingPower.Fields().ByName("delegator_address")
}

var _ protoreflect.Message = (*fastReflection_MsgShareVotingPower)(nil)

type fastReflection_MsgShareVotingPower MsgShareVotingPower

func (x *MsgShareVotingPower) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgShareVotingPower)(x)
}

func (x *MsgShareVotingPower) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgShareVotingPower_messageType fastReflection_MsgShareVotingPower_messageType
var _ protoreflect.MessageType = fastReflection_MsgShareVotingPower_messageType{}

type fastReflection_MsgShareVotingPower_messageType struct{}

func (x fastReflection_MsgShareVotingPower_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgShareVotingPower)(nil)
}
func (x fastReflection_MsgShareVotingPower_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgShareVotingPower)
}
func (x fastReflection_MsgShareVotingPower_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgShareVotingPower
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgShareVotingPower) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgShareVotingPower
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgShareVotingPower) Type() protoreflect.MessageType {
	return _fastReflection_MsgShareVotingPower_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgShareVotingPower) New() protoreflect.Message {
	return new(fastReflection_MsgShareVotingPower)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgShareVotingPower) Interface() protoreflect.ProtoMessage {
	return (*MsgShareVotingPower)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgShareVotingPower) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.VotingPowerShares != "" {
		value := protoreflect.ValueOfString(x.VotingPowerShares)
		if !f(fd_MsgShareVotingPower_voting_power_shares, value) {
			return
		}
	}
	if x.DelegatorAddress != "" {
		value := protoreflect.ValueOfString(x.DelegatorAddress)
		if !f(fd_MsgShareVotingPower_delegator_address, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgShareVotingPower) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgShareVotingPower.voting_power_shares":
		return x.VotingPowerShares != ""
	case "cosmos.gov.v1.MsgShareVotingPower.delegator_address":
		return x.DelegatorAddress != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPower"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgShareVotingPower does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPower) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgShareVotingPower.voting_power_shares":
		x.VotingPowerShares = ""
	case "cosmos.gov.v1.MsgShareVotingPower.delegator_address":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgShareVotingPower) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.gov.v1.MsgShareVotingPower.voting_power_shares":
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.gov.v1.MsgShareVotingPower does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPower) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgShareVotingPower.voting_power_shares":
		x.VotingPowerShares = value.Interface().(string)
	case "cosmos.gov.v1.MsgShareVotingPower.delegator_address":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPower) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgShareVotingPower.voting_power_shares":
		panic(fmt.Errorf("field voting_power_shares of message cosmos.gov.v1.MsgShareVotingPower is not mutable"))
	case "cosmos.gov.v1.MsgShareVotingPower.delegator_address":
		panic(fmt.Errorf("field delegator_address of message cosmos.gov.v1.MsgShareVotingPower is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPower"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgShareVotingPower) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.gov.v1.MsgShareVotingPower.voting_power_shares":
		return protoreflect.ValueOfString("")
	case "cosmos.gov.v1.MsgShareVotingPower.delegator_address":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgShareVotingPower) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.MsgShareVotingPower", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgShareVotingPower) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPower) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgShareVotingPower) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgShareVotingPower) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgShareVotingPower)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.VotingPowerShares) > 0 {
			i -= len(x.VotingPowerShares)
			copy(dAtA[i:], x.VotingPowerShares)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.VotingPowerShares)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgShareVotingPower: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgShareVotingPower: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.VotingPowerShares = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
...
var (
	md_MsgShareVotingPowerResponse protoreflect.MessageDescriptor
)

func init() {
	file_cosmos_gov_v1_tx_proto_init()
	md_MsgShareVotingPowerResponse = File_cosmos_gov_v1_tx_proto.Messages().ByName("MsgShareVotingPowerResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgShareVotingPowerResponse)(nil)

type fastReflection_MsgShareVotingPowerResponse MsgShareVotingPowerResponse

func (x *MsgShareVotingPowerResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgShareVotingPowerResponse)(x)
}

func (x *MsgShareVotingPowerResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgShareVotingPowerResponse_messageType fastReflection_MsgShareVotingPowerResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgShareVotingPowerResponse_messageType{}

type fastReflection_MsgShareVotingPowerResponse_messageType struct{}

func (x fastReflection_MsgShareVotingPowerResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgShareVotingPowerResponse)(nil)
}
func (x fastReflection_MsgShareVotingPowerResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgShareVotingPowerResponse)
}
func (x fastReflection_MsgShareVotingPowerResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgShareVotingPowerResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgShareVotingPowerResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgShareVotingPowerResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgShareVotingPowerResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgShareVotingPowerResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgShareVotingPowerResponse) New() protoreflect.Message {
	return new(fastReflection_MsgShareVotingPowerResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgShareVotingPowerResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgShareVotingPowerResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgShareVotingPowerResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgShareVotingPowerResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPowerResponse"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgShareVotingPowerResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPowerResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPowerResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgShareVotingPowerResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPowerResponse"))
		}
		panic(fmt.Errorf("message cosmos.gov.v1.MsgShareVotingPowerResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPowerResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPowerResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPowerResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPowerResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgShareVotingPowerResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.MsgShareVotingPowerResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgShareVotingPowerResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.gov.v1.MsgShareVotingPowerResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgShareVotingPowerResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgShareVotingPowerResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgShareVotingPowerResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgShareVotingPowerResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgShareVotingPowerResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgShareVotingPowerResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgShareVotingPowerResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
// MsgCreateRepresentative defines a SDK message for creating a new representative.
type MsgCreateRepresentative struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Description           *RepDescription `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty"`
	RepresentativeAddress string          `protobuf:"bytes,2,opt,name=representative_address,json=representativeAddress,proto3" json:"representative_address,omitempty"`
}

func (x *MsgCreateRepresentative) Reset() {
	*x = MsgCreateRepresentative{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1_tx_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgCreateRepresentative) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgCreateRepresentative) ProtoMessage() {}

// Deprecated: Use MsgCreateRepresentative.ProtoReflect.Descriptor instead.
func (*MsgCreateRepresentative) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_tx_proto_rawDescGZIP(), []int{14}
}

func (x *MsgCreateRepresentative) GetDescription() *RepDescription {
	if x != nil {
...
func (x *MsgCreateRepresentative) GetRepresentativeAddress() string {
	if x != nil {
		return x.RepresentativeAddress
	}
	return ""
...
// MsgCreateRepresentativeResponse defines the Msg/CreateRepresentative response type.
type MsgCreateRepresentativeResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *MsgCreateRepresentativeResponse) Reset() {
	*x = MsgCreateRepresentativeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1_tx_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgCreateRepresentativeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgCreateRepresentativeResponse) ProtoMessage() {}

// Deprecated: Use MsgCreateRepresentativeResponse.ProtoReflect.Descriptor instead.
func (*MsgCreateRepresentativeResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_tx_proto_rawDescGZIP(), []int{15}
}

// MsgShareVotingPower defines a SDK message for a delegator to share its voting power to representatives.
type MsgShareVotingPower struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	VotingPowerShares string `protobuf:"bytes,1,opt,name=voting_power_shares,json=votingPowerShares,proto3" json:"voting_power_shares,omitempty"`
...
func (x *MsgShareVotingPower) Reset() {
	*x = MsgShareVotingPower{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1_tx_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgShareVotingPower) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgShareVotingPower) ProtoMessage() {}

// Deprecated: Use MsgShareVotingPower.ProtoReflect.Descriptor instead.
func (*MsgShareVotingPower) Descriptor() ([]byte, []int) {
	return file_cosmos_gov_v1_tx_proto_rawDescGZIP(), []int{16}
}

func (x *MsgShareVotingPower) GetVotingPowerShares() string {
	if x != nil {
		return x.VotingPowerShares
	}
	return ""
...
func (x *MsgShareVotingPower) GetDelegatorAddress() string {
	if x != nil {
		return x.DelegatorAddress
	}
	return ""
...
// MsgShareVotingPowerResponse defines the Msg/ShareVotingPower response type.
type MsgShareVotingPowerResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *MsgShareVotingPowerResponse) Reset() {
	*x = MsgShareVotingPowerResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_gov_v1_tx_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgShareVotingPowerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgShareVotingPowerResponse) ProtoMessage() {}

// Deprecated: Use MsgShareVotingPowerResponse.ProtoReflect.Descriptor instead.
func (*MsgShareVotingPowerResponse) Descriptor() ([]byte, []int) {
...
var file_cosmos_gov_v1_tx_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x74, 0x6f, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x3a, 0x16, 0x82, 0xe7, 0xb0,
	0x2a, 0x11, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x22, 0x1d, 0x0a, 0x1b, 0x4d, 0x73, 0x67, 0x53, 0x68, 0x61, 0x72, 0x65, 0x56,
	0x6f, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x32, 0xbc, 0x06, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x5c, 0x0a, 0x0e, 0x53, 0x75,
	...
	,
...
var file_cosmos_gov_v1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_cosmos_gov_v1_tx_proto_goTypes = []interface{}{
	...
	(*MsgCreateRepresentative)(nil),         // 14: cosmos.gov.v1.MsgCreateRepresentative
	(*MsgCreateRepresentativeResponse)(nil), // 15: cosmos.gov.v1.MsgCreateRepresentativeResponse
	(*MsgShareVotingPower)(nil),             // 16: cosmos.gov.v1.MsgShareVotingPower
	(*MsgShareVotingPowerResponse)(nil),     // 17: cosmos.gov.v1.MsgShareVotingPowerResponse
	(*anypb.Any)(nil),                       // 18: google.protobuf.Any
	(*v1beta1.Coin)(nil),                    // 19: cosmos.base.v1beta1.Coin
	(VoteOption)(0),                         // 20: cosmos.gov.v1.VoteOption
	(*WeightedVoteOption)(nil),              // 21: cosmos.gov.v1.WeightedVoteOption
	(*Params)(nil),                          // 22: cosmos.gov.v1.Params
	(*timestamppb.Timestamp)(nil),           // 23: google.protobuf.Timestamp
	(*RepDescription)(nil),                  // 24: cosmos.gov.v1.RepDescription
}
var file_cosmos_gov_v1_tx_proto_depIdxs = []int32{
	18, // 0: cosmos.gov.v1.MsgSubmitProposal.messages:type_name -> google.protobuf.Any
	19, // 1: cosmos.gov.v1.MsgSubmitProposal.initial_deposit:type_name -> cosmos.base.v1beta1.Coin
	18, // 2: cosmos.gov.v1.MsgExecLegacyContent.content:type_name -> google.protobuf.Any
	20, // 3: cosmos.gov.v1.MsgVote.option:type_name -> cosmos.gov.v1.VoteOption
	21, // 4: cosmos.gov.v1.MsgVoteWeighted.options:type_name -> cosmos.gov.v1.WeightedVoteOption
	19, // 5: cosmos.gov.v1.MsgDeposit.amount:type_name -> cosmos.base.v1beta1.Coin
	22, // 6: cosmos.gov.v1.MsgUpdateParams.params:type_name -> cosmos.gov.v1.Params
	23, // 7: cosmos.gov.v1.MsgCancelProposalResponse.canceled_time:type_name -> google.protobuf.Timestamp
	24, // 8: cosmos.gov.v1.MsgCreateRepresentative.description:type_name -> cosmos.gov.v1.RepDescription
	...
	6,  // 12: cosmos.gov.v1.Msg.VoteWeighted:input_type -> cosmos.gov.v1.MsgVoteWeighted
	8,  // 13: cosmos.gov.v1.Msg.Deposit:input_type -> cosmos.gov.v1.MsgDeposit
	10, // 14: cosmos.gov.v1.Msg.UpdateParams:input_type -> cosmos.gov.v1.MsgUpdateParams
	12, // 15: cosmos.gov.v1.Msg.CancelProposal:input_type -> cosmos.gov.v1.MsgCancelProposal
	14, // 16: cosmos.gov.v1.Msg.CreateRepresentative:input_type -> cosmos.gov.v1.MsgCreateRepresentative
	16, // 17: cosmos.gov.v1.Msg.ShareVotingPower:input_type -> cosmos.gov.v1.MsgShareVotingPower
	...
	13, // 24: cosmos.gov.v1.Msg.CancelProposal:output_type -> cosmos.gov.v1.MsgCancelProposalResponse
	15, // 25: cosmos.gov.v1.Msg.CreateRepresentative:output_type -> cosmos.gov.v1.MsgCreateRepresentativeResponse
	17, // 26: cosmos.gov.v1.Msg.ShareVotingPower:output_type -> cosmos.gov.v1.MsgShareVotingPowerResponse
...
func file_cosmos_gov_v1_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_gov_v1_tx_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgCreateRepresentative); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_gov_v1_tx_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgCreateRepresentativeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_gov_v1_tx_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgShareVotingPower); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_gov_v1_tx_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgShareVotingPowerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
